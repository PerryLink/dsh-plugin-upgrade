...
- **यहाँ के हर कॉरिडोर से आगे की कोई छलांग।** `legAB` रचना से ही `0.1.5-rc.1` पर समाप्त होता है: हार्नेस की छलांग `0.1.5-rc.1` → `0.1.5-rc.2` ने प्लगइन-मुखी कोई सीम नहीं जोड़ी (इस पैकेज का अपना dev/test pin अब `0.1.7-alpha.2` लाइन पर चलता है, ताकि कैटलॉग उन प्रकाशित टाइप के विरुद्ध सत्यापित हो; compat workflow का प्रोब अभी भी `0.1.6-alpha.2` पर anchored है), और `legC` `0.1.5-rc.2` → `0.1.6-alpha.2` को कवर करता है। बाद में सीम जोड़ने वाली कोई छलांग **कवर नहीं** होती: कॉरिडोर बंद होता है, और कार्ड को चौड़ा करना नया कार्ड जोड़ने से बुरा है। उसे नया कार्ड और सूचकांक में नई पंक्ति मिलती है — नया पैकेज नहीं।
