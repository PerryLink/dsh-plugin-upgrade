...
| सतह | स्थिति |
|---|---|
| हार्नेस | DeepSeek Harness `0.1.5-alpha.1` (checkout `19d2e38480`, tag `dsh-v0.1.5-alpha.1` = `5dda764ed3`)। पीयर बैंड `@deepseek-ai/dsh-skill >=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0`, `@deepseek-ai/cordis ^4.0.2`, `@deepseek-ai/schemastery ^3.18.2`। |
| Node | `^22.19.0 \|\| >=24.0.0` |
